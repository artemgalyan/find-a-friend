...
public class UserDao implements Dao<Integer, User>{
    private static final String SQL_SELECT_ALL_USERS = "SELECT user_id, name, surname, email, phone_number, login, password, role.role_id, role.name" +
            " FROM user LEFT JOIN role USING(role_id)";
    private static final String SQL_SELECT_BY_ID = "SELECT user_id, name, surname, email, phone_number, login, password, role.role_id, role.name" +
            " FROM user LEFT JOIN role USING(role_id)" +
            " WHERE user_id=?";
    ...
    public static final String SQL_DELETE_BY_ID = "DELETE FROM advert WHERE user_id=?";
